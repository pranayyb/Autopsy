...
const Risks = () => {
    ...
    const fetchRiskData = useCallback(async () => {
        ...
        try {
            const [risksRes, healthRes, topTasksRes, timelineRes] =
                await Promise.all([
        ...
        <div className="space-y-6">
            ...
            {loadingRisks ? (
                ...
                <>
                                ...
                                <div className="mt-4">
                                    <div className="w-full h-2 bg-slate-700/50 rounded-full overflow-hidden">
                                        <div
                                            ...
                                            style={{
                                                width: `${projectHealth.projectHealthScore}%`,
                                            }}
                                        />
                                    </div>
                                </div>
                                        ...
                                        >
                                            ...
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2 mb-1">
                                                    <span
                                                        className={`px-2 py-0.5 text-xs font-medium rounded-full border ${getRiskTypeColor(event.type)}`}
                                                    >
                                                        {getRiskTypeLabel(
                                                            event.type,
                                                        )}
                                            ...
                                            <div key={risk._id} className="p-4">
                                                <div className="flex items-start justify-between gap-4">
                                                    ...
                                                    <button
                                                        ...
                                                        className="px-3 py-1.5 bg-green-600/20 hover:bg-green-600/30 text-green-400 text-xs rounded-xl transition-colors border border-green-500/30"
                                                    >
                                                        Resolve
                                                    </button>
                                                </div>
                    ...
                    {/* Type Breakdown */}
                    {projectHealth?.typeBreakdown &&
                        Object.keys(projectHealth.typeBreakdown).length > 0 && (
                            <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-700/50 p-5">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    {Object.entries(
                                        ...
                                        <div
                                            key={type}
                                            className="bg-slate-700/30 rounded-xl p-4 text-center card-hover"
                                        >
