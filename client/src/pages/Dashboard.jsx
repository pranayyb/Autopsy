    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                <Link
                    to="/projects/new"
                    className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-6 hover:from-blue-500 hover:to-blue-600 transition-all group shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30 hover:scale-[1.02]"
                >
                ...
                <Link
                    to="/projects"
                    className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50 hover:border-slate-600/70 transition-all card-hover"
                >
                    <div className="flex items-center gap-4">
                ...
                {projects.length === 0 ? (
                    ...
                    <div className="divide-y divide-slate-700/50">
                        {projects.slice(0, 5).map((project) => (
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    <div className="w-11 h-11 bg-slate-700/50 rounded-xl flex items-center justify-center">
