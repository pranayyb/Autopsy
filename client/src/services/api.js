...
export const projectsAPI = {
  ...
  update: (projectId, data) => api.put(`/projects/${projectId}/update-project`, data),
  ...
  updateMemberRole: (projectId, memberId, role) =>
    api.patch(`/projects/${projectId}/update-member-role/${memberId}`, { role }),
...
export const tasksAPI = {
  create: (projectId, data) => api.post(`/tasks/${projectId}/create-task`, data),
  getAll: (projectId) => api.get(`/tasks/${projectId}/get-tasks`),
  getOne: (projectId, taskId) => api.get(`/tasks/${projectId}/${taskId}/get-task-details`),
  update: (projectId, taskId, data) => api.put(`/tasks/${projectId}/${taskId}/update-task`, data),
  updateStatus: (projectId, taskId, status) =>
    api.patch(`/tasks/${projectId}/${taskId}/update-status`, { status }),
  delete: (projectId, taskId) => api.delete(`/tasks/${projectId}/${taskId}/delete-task`),
};

// Risks API
export const risksAPI = {
  getProjectHealth: (projectId) => api.get(`/risks/${projectId}/get-project-health`),
